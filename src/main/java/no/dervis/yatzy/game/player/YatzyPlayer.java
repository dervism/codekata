...
import no.dervis.yatzy.http.Dice;
import no.dervis.yatzy.http.DiceLocal;
import no.dervis.yatzy.model.Category;
import no.dervis.yatzy.model.ScoreCard;
import no.dervis.yatzy.model.ThrowState;
import no.dervis.yatzy.model.maximizer.FrequencyMaximizer;
import no.dervis.yatzy.model.maximizer.Maximizer;
import no.dervis.yatzy.model.selection.MaxValueSelection;
import no.dervis.yatzy.model.selection.MinValueSelection;
import no.dervis.yatzy.model.selection.SelectionParams;
import no.dervis.yatzy.model.selection.SortedSelection;
